...
{
	ending_edge = 256 * ICR1H + ICR1L;					// also with bit shifting usable e.g: (ICR1H << 8) | ICR1L
...
void initTimer1()
{
	...
	TIMSK |= (1 << TICIE1) | (1 << TOIE1);	// Capture Interrupt enable, Overflow Interrupt enable
}
